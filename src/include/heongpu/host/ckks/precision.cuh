...
namespace heongpu
{
    ...
    struct PrecisionStats
    {
        ...
        PrecisionStats()
            : max_delta(0.0, 0.0, 0.0), min_delta(1.0, 1.0, 1.0),
              max_precision(0.0, 0.0, 0.0), min_precision(0.0, 0.0, 0.0),
              mean_delta(0.0, 0.0, 0.0), mean_precision(0.0, 0.0, 0.0),
              median_delta(0.0, 0.0, 0.0), median_precision(0.0, 0.0, 0.0),
              cdf_resol(500)
        {
        }
