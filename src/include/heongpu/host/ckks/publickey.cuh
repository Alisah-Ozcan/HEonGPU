...
#ifndef HEONGPU_CKKS_PUBLICKEY_H
#define HEONGPU_CKKS_PUBLICKEY_H
...
namespace heongpu
{
    ...
    template <> class Publickey<Scheme::CKKS>
    {
      ...
      public:
         ...
         */
        __host__ Publickey(HEContext<Scheme::CKKS>& context);
     ...
     */
    template <>
    class MultipartyPublickey<Scheme::CKKS> : public Publickey<Scheme::CKKS>
    {
        template <Scheme S> friend class HEKeyGenerator;

      public:
        __host__ MultipartyPublickey(HEContext<Scheme::CKKS>& context,
                                     const RNGSeed seed);
...
#endif // HEONGPU_CKKS_PUBLICKEY_H