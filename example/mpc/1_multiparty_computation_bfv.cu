...
int main(int argc, char* argv[])
{
    ...
    heongpu::HEDecryptor<heongpu::Scheme::BFV> decryptor_alice(
    ...
    heongpu::HEDecryptor<heongpu::Scheme::BFV> decryptor_bob(context,
                                                             secret_key_alice);
    ...
    heongpu::HEDecryptor<heongpu::Scheme::BFV> decryptor_charlie(
        context, secret_key_alice);
