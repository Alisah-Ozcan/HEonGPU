...
int main(int argc, char* argv[])
{
    ...
    heongpu::HEDecryptor<heongpu::Scheme::CKKS> decryptor_alice(
        context, secret_key_alice);
    ...
    heongpu::HEDecryptor<heongpu::Scheme::CKKS> decryptor_bob(context,
                                                              secret_key_alice);
    ...
    heongpu::HEDecryptor<heongpu::Scheme::CKKS> decryptor_charlie(
        context, secret_key_alice);
