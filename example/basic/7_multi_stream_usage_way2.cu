...
void multi_stream_function_way2(
    ...
    int count, std::vector<cudaStream_t>& s)
{
    ...
    for (int i = 0; i < count; i++)
    {
        ...
        heongpu::Ciphertext<Scheme> result(
            context, heongpu::ExecutionOptions().set_stream(s[streamID]));
